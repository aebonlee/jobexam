...
export default function LoginPage() {
  const { user, signInWithGoogle, signInWithKakao, signingIn } = useAuth();
      ...
      <div className="login-container">
        <div className="login-card">
          ...
          <div className="login-buttons">
            <button className="login-btn google-btn" onClick={signInWithGoogle} disabled={signingIn}>
              <span className="login-icon">
                {signingIn ? <i className="fa-solid fa-spinner fa-spin" /> : (
            ...
            <button className="login-btn kakao-btn" onClick={signInWithKakao} disabled={signingIn}>
              <span className="login-icon">
                {signingIn ? <i className="fa-solid fa-spinner fa-spin" /> : (
                <svg viewBox="0 0 24 24" width="20" height="20">
