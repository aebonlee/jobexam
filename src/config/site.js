export const SITE = {
  ...
  url: 'https://jobexam.dreamitbiz.com',
  domain: 'jobexam.dreamitbiz.com',
};
...
export const PLANS = [
  { id: '3month', label: '3개월 이용권', price: 29900, days: 90, desc: '1회차 시험 준비' },
  { id: '6month', label: '6개월 이용권', price: 49900, days: 180, recommended: true, desc: '2회차 시험 준비' },
  { id: '12month', label: '12개월 이용권', price: 79900, days: 365, desc: '연간 전 회차 대비' },
];
