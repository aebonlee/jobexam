import{n as e}from"./rolldown-runtime-DF2fYuay.js";import{f as t,r as n,t as r}from"./vendor-0O6AGl4b.js";import{t as i}from"./SEOHead-CG-Z0OLy.js";import{n as a,r as o,t as s}from"./silgiFrequent-DY_Kpf70.js";var c=e(t(),1),l=[{id:`all`,label:`전체`,color:`#6366F1`,icon:`fa-solid fa-list`},{id:`counseling`,label:`직업상담학`,color:`#3B82F6`,icon:`fa-solid fa-comments`},{id:`psychology`,label:`직업심리학`,color:`#8B5CF6`,icon:`fa-solid fa-brain`},{id:`jobinfo`,label:`직업정보론`,color:`#10B981`,icon:`fa-solid fa-circle-info`},{id:`labor_market`,label:`노동시장론`,color:`#F59E0B`,icon:`fa-solid fa-chart-line`},{id:`labor_law`,label:`노동관계법규`,color:`#EF4444`,icon:`fa-solid fa-scale-balanced`}],u=[{num:1,category:`counseling`,title:`특성-요인 상담이론 (윌리엄슨)`,keyword:`특성-요인이론, 윌리엄슨, Williamson`,frequency:`매회 출제 (39/39회)`,summary:`<ul>
...
</ul>`}];function d(e){return!e||e===`all`?u:u.filter(t=>t.category===e)}function f(){let e={};for(let t of l)t.id!==`all`&&(e[t.id]=u.filter(e=>e.category===t.id).length);return e.all=u.length,e}var p=[{id:`all`,label:`전체`,color:`#6366F1`,icon:`fa-solid fa-list`},{id:`psychology`,label:`직업심리`,color:`#8B5CF6`,icon:`fa-solid fa-brain`},{id:`counseling`,label:`직업상담 및 취업지원`,color:`#3B82F6`,icon:`fa-solid fa-comments`},{id:`jobinfo`,label:`직업정보`,color:`#10B981`,icon:`fa-solid fa-circle-info`},{id:`labor_market`,label:`노동시장`,color:`#F59E0B`,icon:`fa-solid fa-chart-line`},{id:`labor_law`,label:`고용노동관계법규`,color:`#EF4444`,icon:`fa-solid fa-scale-balanced`}],m=[{num:1,category:`psychology`,stars:4,title:`파슨스의 직업선택 3요인`,content:`<ul>
...
<p><em>* 훈련교사 양성을 위한 훈련과정은 양성훈련·향상훈련·교직훈련과정으로 구분</em></p>`},{num:118,category:`labor_law`,stars:3,title:`직장 내 성희롱 예방교육`,content:`<p>상시 근로자가 <strong>10명 미만</strong>인 사업, 사업주 및 근로자 모두가 남성 또는 여성 중 어느 한 성(性)으로만 구성된 사업에서는 성희롱 예방교육 내용을 근로자가 알 수 있도록 교육자료 또는 홍보물을 게시하거나 배포하는 방법으로 직장 내 성희롱 예방교육을 대신할 수 있다.</p>`},{num:119,category:`labor_law`,stars:3,title:`육아휴직`,content:`<p>사업주는 근로자가 <strong>만 8세 이하 또는 초등학교 2학년 이하</strong>의 자녀(입양한 자녀 포함)를 양육하기 위하여 육아휴직을 신청하는 경우에 이를 허용해야 한다. 육아휴직기간은 <strong>1년 이내</strong>로 하며, 그 기간은 근속기간에 포함한다.</p>`},{num:120,category:`labor_law`,stars:5,title:`개인정보보호위원회`,content:`<p>개인정보 보호에 관한 사무를 독립적으로 수행하기 위하여 <strong>국무총리 소속</strong>으로 개인정보 보호위원회를 둔다.</p>`}];function h(e){return!e||e===`all`?m:m.filter(t=>t.category===e)}function g(){let e={};for(let t of p)t.id!==`all`&&(e[t.id]=m.filter(e=>e.category===t.id).length);return e.all=m.length,e}var _=r(),v=e=>`★`.repeat(e)+`☆`.repeat(5-e);function y({topic:e,isOpen:t,onToggle:n,cardRef:r}){let i=l.find(t=>t.id===e.category);return(0,_.jsxs)(`div`,{className:`sq-card ${t?`sq-card--open`:``}`,ref:r,id:`topic-${e.num}`,children:[(0,_.jsxs)(`button`,{className:`sq-card-header`,onClick:n,type:`button`,children:[(0,_.jsxs)(`div`,{className:`sq-card-num`,children:[`Q`,e.num]}),(0,_.jsxs)(`div`,{className:`sq-card-title-area`,children:[(0,_.jsx)(`h3`,{className:`sq-card-title`,children:e.title}),(0,_.jsxs)(`div`,{className:`sq-card-meta`,children:[(0,_.jsx)(`span`,{className:`sq-badge`,style:{background:`${i?.color}18`,color:i?.color},children:i?.label}),(0,_.jsx)(`span`,{className:`sq-badge sq-badge--keyword`,children:e.keyword})]})]}),(0,_.jsx)(`div`,{className:`sq-card-toggle`,children:(0,_.jsx)(`i`,{className:`fa-solid fa-chevron-${t?`up`:`down`}`})})]}),t&&(0,_.jsxs)(`div`,{className:`sq-card-body`,children:[(0,_.jsxs)(`div`,{className:`sq-frequency`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-chart-bar`}),(0,_.jsxs)(`span`,{children:[`출제빈도: `,e.frequency]})]}),(0,_.jsxs)(`div`,{className:`sq-section`,children:[(0,_.jsxs)(`div`,{className:`sq-section-label`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-check-circle`}),(0,_.jsx)(`span`,{children:`핵심 요약`})]}),(0,_.jsx)(`div`,{className:`sq-section-content`,dangerouslySetInnerHTML:{__html:e.summary}})]})]})]})}function b(e){return e>=5?{label:`최다빈출`,cls:`sq-freq-grade--5`,icon:`fa-solid fa-fire-flame-curved`}:e>=4?{label:`고빈출`,cls:`sq-freq-grade--4`,icon:`fa-solid fa-fire`}:e>=3?{label:`빈출`,cls:`sq-freq-grade--3`,icon:`fa-solid fa-bolt`}:e>=2?{label:`출제`,cls:`sq-freq-grade--2`,icon:`fa-solid fa-circle-check`}:{label:`1회`,cls:`sq-freq-grade--1`,icon:`fa-regular fa-circle`}}function x({topic:e,rank:t,isOpen:n,onToggle:r,cardRef:i}){let a=s.find(t=>t.id===e.category),o=b(e.freqCount);return(0,_.jsxs)(`div`,{className:`sq-card ${n?`sq-card--open`:``} ${o.cls}`,ref:i,id:`topic-${e.num}`,children:[(0,_.jsxs)(`button`,{className:`sq-card-header`,onClick:r,type:`button`,children:[(0,_.jsxs)(`div`,{className:`sq-card-num`,children:[`#`,t]}),(0,_.jsxs)(`div`,{className:`sq-card-title-area`,children:[(0,_.jsx)(`h3`,{className:`sq-card-title`,children:e.title}),(0,_.jsxs)(`div`,{className:`sq-card-meta`,children:[(0,_.jsx)(`span`,{className:`sq-badge`,style:{background:`${a?.color}18`,color:a?.color},children:a?.label}),(0,_.jsx)(`span`,{className:`sq-badge sq-badge--keyword`,children:e.keyword}),(0,_.jsxs)(`span`,{className:`sq-badge sq-badge--freq-grade ${o.cls}`,children:[(0,_.jsx)(`i`,{className:o.icon}),` `,e.freqCount,`회 · `,o.label]})]})]}),(0,_.jsx)(`div`,{className:`sq-card-toggle`,children:(0,_.jsx)(`i`,{className:`fa-solid fa-chevron-${n?`up`:`down`}`})})]}),n&&(0,_.jsxs)(`div`,{className:`sq-card-body`,children:[(0,_.jsxs)(`div`,{className:`sq-frequency`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-clock-rotate-left`}),(0,_.jsxs)(`span`,{children:[`출제 이력: `,e.frequency]})]}),(0,_.jsxs)(`div`,{className:`sq-section`,children:[(0,_.jsxs)(`div`,{className:`sq-section-label`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-file-lines`}),(0,_.jsx)(`span`,{children:`상세 해설`})]}),(0,_.jsx)(`div`,{className:`sq-section-content`,dangerouslySetInnerHTML:{__html:e.answer}})]})]})]})}function S({topic:e,isOpen:t,onToggle:n,cardRef:r}){let i=p.find(t=>t.id===e.category);return(0,_.jsxs)(`div`,{className:`sq-card ${t?`sq-card--open`:``}`,ref:r,id:`topic-${e.num}`,children:[(0,_.jsxs)(`button`,{className:`sq-card-header`,onClick:n,type:`button`,children:[(0,_.jsx)(`div`,{className:`sq-card-num`,children:e.num}),(0,_.jsxs)(`div`,{className:`sq-card-title-area`,children:[(0,_.jsx)(`h3`,{className:`sq-card-title`,children:e.title}),(0,_.jsxs)(`div`,{className:`sq-card-meta`,children:[(0,_.jsx)(`span`,{className:`sq-badge`,style:{background:`${i?.color}18`,color:i?.color},children:i?.label}),(0,_.jsx)(`span`,{className:`sq-badge sq-badge--stars`,children:v(e.stars)})]})]}),(0,_.jsx)(`div`,{className:`sq-card-toggle`,children:(0,_.jsx)(`i`,{className:`fa-solid fa-chevron-${t?`up`:`down`}`})})]}),t&&(0,_.jsxs)(`div`,{className:`sq-card-body`,children:[(0,_.jsxs)(`div`,{className:`sq-frequency`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-star`}),(0,_.jsxs)(`span`,{children:[`중요도: `,v(e.stars)]})]}),(0,_.jsxs)(`div`,{className:`sq-section`,children:[(0,_.jsxs)(`div`,{className:`sq-section-label`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-lightbulb`}),(0,_.jsx)(`span`,{children:`핵심 내용`})]}),(0,_.jsx)(`div`,{className:`sq-section-content`,dangerouslySetInnerHTML:{__html:e.content}})]})]})]})}function C(){let[e,t]=(0,c.useState)(`pilgi`),[r,v]=(0,c.useState)(`all`),[b,C]=(0,c.useState)(new Set),[w,T]=(0,c.useState)(``),[E,D]=(0,c.useState)(new Set),O=(0,c.useRef)({}),k=(0,c.useMemo)(()=>[...a].map(e=>({...e,freqCount:(e.frequency.match(/,/g)||[]).length+1})).sort((e,t)=>t.freqCount-e.freqCount),[]),A=e===`pilgi`?l:e===`silgi`?s:p,j=(0,c.useMemo)(()=>e===`pilgi`?f():e===`silgi`?o():g(),[e]),M=e===`pilgi`?u:e===`silgi`?k:m,N=(0,c.useMemo)(()=>{let e={};for(let t of A)t.id!==`all`&&(e[t.id]=M.filter(e=>e.category===t.id));return e},[e,M,A]),P=(0,c.useMemo)(()=>{let t;if(t=e===`pilgi`?d(r):e===`silgi`?!r||r===`all`?k:k.filter(e=>e.category===r):h(r),w.trim()){let e=w.trim().toLowerCase();t=t.filter(t=>t.title.toLowerCase().includes(e))}return t},[e,r,w,k]),F=n=>{n!==e&&(t(n),v(`all`),C(new Set),T(``),D(new Set))},I=e=>{C(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},L=()=>{C(new Set(P.map(e=>e.num)))},R=()=>{C(new Set)},z=e=>{D(t=>t.has(e)?new Set:new Set([e]))},B=e=>{C(t=>{let n=new Set(t);return n.add(e),n}),setTimeout(()=>{let t=O.current[e];t&&t.scrollIntoView({behavior:`smooth`,block:`start`})},50)},V=e=>{v(e),C(new Set),T(``)},H=e===`pilgi`,U=e===`silgi`,W=e===`keynote`,G=H?`필기 빈출 주제 정리`:U?`실기 빈출 문항 정리`:`D-1 핵심노트 120선`,K=H?`직업상담사 2급 필기 2010~2022 39회 시험 빈출 핵심 주제 60개 요약 정리`:U?`직업상담사 2급 실기 2018~2025 8개년 빈출 핵심 문항 201개 빈출순 정리`:`직업상담사 2급 필기 D-1 빈출개념 노트 120개 핵심 요약`,q=H?`필기시험 39회 분석 · 핵심 빈출 주제 ${u.length}개 요약`:U?`실기시험 8개년 분석 · 빈출 문항 ${a.length}개 빈출순 정리`:`D-1 빈출개념 노트 · 핵심 ${m.length}개 개념 정리`,J=H?`주제`:U?`문항`:`개념`;return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(i,{title:G,description:K}),(0,_.jsx)(`div`,{className:`page-header`,children:(0,_.jsxs)(`div`,{className:`container`,children:[(0,_.jsxs)(n,{to:`/learn`,className:`sq-back-link`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-arrow-left`}),` 과목별 학습`]}),(0,_.jsx)(`h1`,{children:`학습 요약`}),(0,_.jsx)(`p`,{className:`page-desc`,children:q})]})}),(0,_.jsx)(`div`,{className:`container`,children:(0,_.jsxs)(`div`,{className:`summary-tabs`,children:[(0,_.jsxs)(`button`,{className:`summary-tab ${H?`active`:``}`,onClick:()=>F(`pilgi`),type:`button`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-pen-to-square`}),` 필기`]}),(0,_.jsxs)(`button`,{className:`summary-tab ${U?`active`:``}`,onClick:()=>F(`silgi`),type:`button`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-file-pen`}),` 실기`]}),(0,_.jsxs)(`button`,{className:`summary-tab ${W?`active`:``}`,onClick:()=>F(`keynote`),type:`button`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-bookmark`}),` 핵심노트`]})]})}),(0,_.jsx)(`div`,{className:`container silgi-exam-page`,children:(0,_.jsxs)(`div`,{className:`summary-layout`,children:[(0,_.jsx)(`aside`,{className:`summary-sidebar`,children:(0,_.jsxs)(`div`,{className:`summary-sidebar-inner`,children:[(0,_.jsxs)(`div`,{className:`summary-sidebar-title`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-bars-staggered`}),(0,_.jsx)(`span`,{children:`과목별 분류`})]}),(0,_.jsxs)(`button`,{className:`summary-sidebar-all ${r===`all`?`active`:``}`,onClick:()=>V(`all`),type:`button`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-list`}),(0,_.jsx)(`span`,{children:`전체 보기`}),(0,_.jsx)(`span`,{className:`summary-sidebar-count`,children:j.all})]}),(0,_.jsx)(`nav`,{className:`summary-sidebar-nav`,children:A.filter(e=>e.id!==`all`).map(e=>{let t=E.has(e.id),n=r===e.id,i=N[e.id]||[];return(0,_.jsxs)(`div`,{className:`summary-sidebar-group`,children:[(0,_.jsxs)(`button`,{className:`summary-sidebar-cat ${n?`active`:``}`,onClick:()=>z(e.id),type:`button`,children:[(0,_.jsx)(`span`,{className:`summary-sidebar-dot`,style:{background:e.color}}),(0,_.jsx)(`span`,{className:`summary-sidebar-cat-label`,children:e.label}),(0,_.jsx)(`span`,{className:`summary-sidebar-count`,children:j[e.id]}),(0,_.jsx)(`i`,{className:`fa-solid fa-chevron-${t?`up`:`down`} summary-sidebar-chevron`})]}),t&&(0,_.jsxs)(`ul`,{className:`summary-sidebar-topics`,children:[(0,_.jsx)(`li`,{children:(0,_.jsxs)(`button`,{className:`summary-sidebar-topic-filter ${n?`active`:``}`,onClick:()=>V(e.id),type:`button`,style:n?{color:e.color}:void 0,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-filter`}),`이 과목만 보기`]})}),i.map(e=>(0,_.jsx)(`li`,{children:(0,_.jsxs)(`button`,{className:`summary-sidebar-topic ${b.has(e.num)?`active`:``}`,onClick:()=>B(e.num),type:`button`,children:[(0,_.jsx)(`span`,{className:`summary-sidebar-topic-num`,children:H?`Q${e.num}`:U?`#${e.num}`:`${e.num}`}),(0,_.jsx)(`span`,{className:`summary-sidebar-topic-title`,children:e.title})]})},e.num))]})]},e.id)})})]})}),(0,_.jsxs)(`div`,{className:`summary-main`,children:[(0,_.jsx)(`div`,{className:`freq-filter summary-mobile-filter`,children:A.map(e=>(0,_.jsxs)(`button`,{className:`freq-filter-btn ${r===e.id?`active`:``}`,onClick:()=>{v(e.id),C(new Set)},type:`button`,style:r===e.id?{background:e.color,borderColor:e.color,color:`#fff`}:void 0,children:[(0,_.jsx)(`i`,{className:e.icon}),(0,_.jsx)(`span`,{children:e.label}),(0,_.jsx)(`span`,{className:`freq-filter-count`,children:j[e.id]})]},e.id))}),(0,_.jsxs)(`div`,{className:`freq-search`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-search`}),(0,_.jsx)(`input`,{type:`text`,placeholder:`${J} 검색 (제목)`,value:w,onChange:e=>T(e.target.value)}),w&&(0,_.jsx)(`button`,{className:`freq-search-clear`,onClick:()=>T(``),type:`button`,children:(0,_.jsx)(`i`,{className:`fa-solid fa-xmark`})})]}),(0,_.jsxs)(`div`,{className:`sq-controls`,children:[(0,_.jsxs)(`button`,{className:`sq-control-btn`,onClick:L,type:`button`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-angles-down`}),` 전체 펼치기`]}),(0,_.jsxs)(`button`,{className:`sq-control-btn`,onClick:R,type:`button`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-angles-up`}),` 전체 접기`]}),(0,_.jsxs)(`span`,{className:`sq-control-count`,children:[P.length,`개 `,J,` `,w&&`(검색: "${w}")`]})]}),(0,_.jsx)(`div`,{className:`sq-list`,children:P.length>0?H?P.map(e=>(0,_.jsx)(y,{topic:e,isOpen:b.has(e.num),onToggle:()=>I(e.num),cardRef:t=>{O.current[e.num]=t}},e.num)):U?P.map((e,t)=>(0,_.jsx)(x,{topic:e,rank:t+1,isOpen:b.has(e.num),onToggle:()=>I(e.num),cardRef:t=>{O.current[e.num]=t}},e.num)):P.map(e=>(0,_.jsx)(S,{topic:e,isOpen:b.has(e.num),onToggle:()=>I(e.num),cardRef:t=>{O.current[e.num]=t}},e.num)):(0,_.jsxs)(`div`,{className:`freq-empty`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-search`}),(0,_.jsx)(`p`,{children:`검색 결과가 없습니다.`})]})}),(0,_.jsx)(`div`,{className:`sq-bottom-nav`,children:H?(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(n,{to:`/learn`,className:`btn btn-secondary`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-arrow-left`}),` 과목별 학습`]}),(0,_.jsxs)(n,{to:`/pilgi`,className:`btn btn-primary`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-pen-to-square`}),` 필기 CBT`]})]}):U?(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(n,{to:`/silgi`,className:`btn btn-secondary`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-file-pen`}),` 실기 시험`]}),(0,_.jsxs)(n,{to:`/silgi/frequent`,className:`btn btn-primary`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-fire`}),` 기출문제 해설`]})]}):(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(n,{to:`/learn`,className:`btn btn-secondary`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-arrow-left`}),` 과목별 학습`]}),(0,_.jsxs)(n,{to:`/pilgi`,className:`btn btn-primary`,children:[(0,_.jsx)(`i`,{className:`fa-solid fa-pen-to-square`}),` 필기 CBT`]})]})})]})]})})]})}export{C as default};